...
const LandingPage = () => {
  ...
  const flashCards = [
    ...
    ["Whats use State", "A hook to rememeber component related data"],
  ];
  ...
  return (
    <div className="flex flex-col flex-wrap items-center m-auto relative z-20 ">
      ...
      <div className="grid grid-cols-2 justify-items-center items-center relative ">
        <img src={Logo} alt="" className="z-[9999] rounded-full h-4/5" />
        <div className="rounded-md flex flex-col items-center justify-evenly bg-black/75 h-[100%]">
          ...
          <p className="text-[2.5vmin] text-white p-20">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione
            optio commodi voluptatibus perspiciatis iste porro animi sequi
            deserunt consectetur voluptatum, accusamus sapiente, excepturi
            dignissimos amet repellat dolorem beatae modi dolorum.
          </p>
          <Link
            to="/login-signup"
